...
class EngineeringRuntime:
    ...
    def __init__(self, workspace: str | Path = ".") -> None:
        ...
        self.analytics_engine = EngineeringAnalytics(
            self.history,
        ...
        self.sprint_manager = EngineeringSprintManager(
            self.history
        )

        self.release_manager = EngineeringReleaseManager(
            self.history,
            self.milestone_engine,
    ...
    def milestones(self) -> str:
        return self.milestone_engine.format_report()
    ...
    def sprint(self) -> str:
        return self.sprint_manager.format_report()

    def release(self) -> str:
        return self.release_manager.format_release()

    def dashboard(self) -> str:
        return self.memory.get_dashboard()

    def progress(self) -> str:
        return self.progress_engine.format_progress()